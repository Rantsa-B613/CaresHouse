          ...
          screenOptions={({ route }) => ({
            tabBarIcon: ({ focused, color, size }) => {
              ...
              if (route.name === "Depense") {
                ...
                iconColor = focused ? "#76CE9E" : "black";
              } else if (route.name === "Home") {
                iconName = focused ? "notifications" : "notifications-outline";
                iconColor = focused ? "#F9C877" : "black";
              } else if (route.name === "Materiel") {
                iconName = focused ? "bed" : "bed";
                iconColor = focused ? "#7B6945" : "black";
              } else if (route.name === "Note") {
                iconName = focused ? "document" : "document-outline";
                iconColor = focused ? "#EBC475" : "black";
              } else if (route.name === "Electricite") {
                iconName = focused ? "flash" : "flash-outline";
                iconColor = focused ? "#504AA8" : "black";
              }
